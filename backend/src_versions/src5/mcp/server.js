...
server.tool(
  ...
  "Retrieve resume evidence for every stored JD requirement using domain-agnostic semantic and lexical evidence. Missing requirements do not expose misleading semantic evidence.",
